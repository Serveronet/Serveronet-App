...
return [
     ...
     */
    'title' => 'Site Developer Api Documentation for Serveronet',
     ...
     */
    'base_url' => 'http://site_id.snet.localhost:15080/',
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => ['site_api/*', 'visitor_file/*'],

                /*
                 * Match only routes whose domains match this pattern (use * as a wildcard to match any characters). Example: 'api.*'.
                 */
                'domains' => ['*{subdomain4?}.{subdomain3?}.{subdomain2?}.{subdomain1?}.{site_id}*'],
             ...
             */
            'apply' => [
                'base_url' => 'http://siteid.snet.localhost:15080/',
    ...
    'static' => [
         ...
         */
        'output_path' => 'public/sn_client_resources/site_api_docs',
    ],
    ...
    'try_it_out' => [
         ...
         */
        // 'base_url' => Str::replaceLast('/', '', config('app.url')),
        'base_url' => '',
         ...
         */
        'csrf_url' => '/site_api/v1/csrf-cookie',
    ],
     ...
     */
    'intro_text' => <<<INTRO
This documentation aims to provide all the information you need to work with Site API.

To make POST request you need to send a csrf token with the request. It is handled automatically with most of JS frameworks

https://laravel.com/docs/13.x/csrf#csrf-x-csrf-token
