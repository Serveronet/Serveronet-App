...
return [
     ...
     */
    'title' => 'Serveronet P2P Internal Api Documentation',
     ...
     */
    'base_url' => env('SCRIBE_APP_URL') ?? 'http://snet.localhost:15080/',
    ...
    'static' => [
         ...
         */
        'output_path' => 'public/sn_client_resources/p2p_api_docs',
    ],
    ...
    'try_it_out' => [
         ...
         */
        'base_url' => 'http://snet.localhost:15080/',
     ...
     */
    'intro_text' => <<<INTRO
This documentation aims to provide about P2P API.
