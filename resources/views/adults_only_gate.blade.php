...
@section('content')
    ...
    <br>
    <a href="{{ route('set_adults_only_access_cookie', ['site_id' => $siteDefinition->site_id]) }}">Continue</a>
    <br>
    <br>
    <a class="btn btn-success btn-lg" href="{{ route('guest_sites') }}">Go back to Index</a>
@endsection
